...
from lesspayne.smh.utils import mkstemp
...
class ExceptionWidget(QtGui.QDialog):
    ...
    def create_github_issue(self):
        ...
        try:
            ...
            response = requests.put(url="https://transfer.sh/screenshot.png",
                                    data=open(path, "rb"))
            ...
            if response.status_code == 200:
                ...
                logger.warn(
                    "Screenshot could not be uploaded (response {})".format(
        ...
        try:
            ...
            response = requests.put(url="https://transfer.sh/session.smh",
                                    data=open(path, "rb"))
            ...
            if response.status_code == 200:
                ...
                logger.warn(
                    "Session could not be uploaded (response {})".format(
                        response.status_code))
        ...
        body = quote(
            body_template.format(
                ...
                formatted_exception="\n".join(
                    tb.format_exception(self.exception_type, self.message,
                                        self.traceback)),
        ...
        url = "https://github.com/andycasey/smhr/issues/new?title={}&body={}".format(
            title, body)
