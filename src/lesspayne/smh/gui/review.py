...
from lesspayne.smh.gui.base import MeasurementSummaryTableModel
...
def _model_has_species(model, species):
    for s in model.species:
        if isinstance(s, list) and species in s:
            return True
        elif isinstance(s, float) and species == s:
            return True
    return False
